...
use Flexix\GeneratorBundle\Generator\CommandGenerator;
...
class GenerateCommandCommand extends GeneratorCommand
{
    ...
    {
        $this
            ->setName('flexix:generate:command')
            ...
            ->setHelp(<<<EOT
The <info>flexix:generate:command</info> command helps you generate new commands
inside bundles. Provide the bundle name as the first argument and the command
name as the second argument:

<info>php app/console flexix:generate:command AppBundle blog:publish-posts</info>
