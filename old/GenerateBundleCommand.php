...
use Flexix\GeneratorBundle\Manipulator\ConfigurationManipulator;
use Flexix\GeneratorBundle\Model\Bundle;
...
use Flexix\GeneratorBundle\Generator\BundleGenerator;
use Flexix\GeneratorBundle\Manipulator\KernelManipulator;
use Flexix\GeneratorBundle\Manipulator\RoutingManipulator;
...
class GenerateBundleCommand extends GeneratorCommand
{
    ...
    {
        $this
            ->setName('flexix:generate:bundle')
    ...
    protected function interact(InputInterface $input, OutputInterface $output)
    {
        ...
        if ($askForBundleName) {
            ...
            $question->setValidator(
                array('Flexix\GeneratorBundle\Command\Validators', 'validateBundleName')
            );
