...
use Flexix\GeneratorBundle\Generator\ControllerGenerator;
...
class GenerateControllerCommand extends GeneratorCommand
{
    ...
    {
        $this
            ->setName('flexix:generate:controller')
...
EOT
    ...
    public function interact(InputInterface $input, OutputInterface $output)
    {
        ...
        while (true) {
            ...
            $question->setValidator(array('Flexix\GeneratorBundle\Command\Validators', 'validateControllerName'));
