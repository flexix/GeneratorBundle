...
use Flexix\GeneratorBundle\Generator\DoctrineEntityGenerator;
...
class GenerateDoctrineEntityCommand extends GenerateDoctrineCommand
{
    ...
    {
        $this
            ->setName('doctrine:flexix:generate:entity')
            ->setAliases(array('flexix:generate:doctrine:entity'))
...
EOT
    ...
    protected function interact(InputInterface $input, OutputInterface $output)
    {
        ...
        while (true) {
            ...
            $question->setValidator(array('Flexix\GeneratorBundle\Command\Validators', 'validateEntityName'));
        ...
        $question->setValidator(array('Flexix\GeneratorBundle\Command\Validators', 'validateFormat'));
