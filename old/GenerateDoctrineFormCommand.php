...
use Flexix\GeneratorBundle\Generator\DoctrineFormGenerator;
...
class GenerateDoctrineFormCommand extends GenerateDoctrineCommand
{
    ...
    {
        $this
            ->setName('doctrine:flexix:generate:form')
            ->setAliases(array('flexix:generate:doctrine:form'))
...
EOT
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $bundle = $this->getApplication()->getKernel()->getBundleDir($bundle);
